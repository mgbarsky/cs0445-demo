/* CS0445 Spring 2023
   ...
   be compared to this object.  See the Prelude in the Carrano text for
   more details on Java interfaces.  See Interlude 1 and Interlude 3 in the
   Carrano text for more details on Java generics.
					...
					// will occur.
{
	...
	// Overriding toString() to show a String representation of this People
	// Recall that toString() is originally defined in class Object
	 ...
	 * method below.  This allows us to access methods specific to the
	 * People class in the rhs argument (such as age()).
	*/
