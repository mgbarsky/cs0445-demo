...
public class MyRectangle
{
	...
	{                                       // Note that the parameter
		...
		if ((xOrig == arg.xOrig) && (yOrig == arg.yOrig) &&
			...
			ans = false;
		//arg.setWidth(1000);  // This would mutate the passed object since both
		                        // copies refer to the same object
		// Demo of Java value parameters
		//arg = new MyRectangle(0,0,0,0);  // This would NOT change the passed object
				// parameter since it is changing the copy which now points to a separate object
		return ans;
	}
    ...
    //you potentialy can test that w and h are positive
